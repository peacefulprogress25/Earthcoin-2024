...
export default function UniswapEarth({ setShowUniswap }) {
    ...
    return (
        <div>
            ...
            <p className="text-[#475467] font-inter font-normal text-[10px] text-left">Make sure to use the following settings on Uniswap.</p>
            <div className="flex p-2 border-[1px] border-[#EAECF0] rounded-lg mt-2">
                ...
                <div className="flex flex-col">
                    ...
                    <p className="text-[#475467] font-inter font-normal text-[10px] text-left">Polygon POS</p>
                </div>
            </div>
            <div className="flex p-2 border-[1px] border-[#EAECF0] rounded-lg mt-2">
