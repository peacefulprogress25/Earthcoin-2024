...
export default function ProjectList({ projects }) {
  ...
  return (
    <div className="max-w-screen-lg mx-auto mt-8 sm:mt-16 h-fit flex flex-col gap-8 sm:gap-12 items-center justify-center w-full px-4 pb-8">
        ...
        sortedProjects.map((project, index) => (
          ...
          >
            ...
            <div className="flex flex-wrap border-t-2 mt-4 w-full border-[#EAECF0]">
              <div className="flex items-center px-1 w-full sm:w-1/3 pt-2 pb-4 border-b-2 sm:border-b-0 sm:border-r-2 border-[#EAECF0] justify-center flex-col">
              ...
              <div className="flex items-center px-1 w-full sm:w-1/3 py-2 pb-3 border-b-2 sm:border-b-0 sm:border-r-2 border-[#EAECF0] justify-center flex-col">
              ...
              <div className="flex items-center py-2 pb-3 px-1 w-full sm:w-1/3 justify-center flex-col">
                <p className="font-syne font-semibold text-[16px] text-center sm:text-[30px] text-[#EC8000]">
                  {project.Irr}
                </p>
                <p className="font-inter font-semibold text-center text-[10px] sm:text-[14px] text-[#101828]">
            ...
            <ImageView
              ...
              width={350}
              height={450}
              className="w-full h-48 sm:h-auto object-cover rounded-b-sm"
            />
          </div>
        ))
      ) : (
