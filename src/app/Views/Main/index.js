...
const climateEnvironmentCrisis = "/assets/images/climate-environment-crisis.png";
...
export default function Main() {
  ...
  const services = [
    {
      title: "Backed by Climate Solutions",
      description:
  ...
  return (
    <div className="mt-20">
      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-[6%] mt-16 h-fit flex flex-col gap-12 items-center justify-center w-full">
        <div className="flex sm:px-[20%] items-center pt-10 px-4 flex-col w-full gap-3">
          ...
          <p className="text-[#475467] text-center font-normal w-[70%]  text-[16px] font-inter">
            Just hold and use $EARTH to be the change you wish to see
          </p>
        </div>
        ...
        <div className="flex gap-x-[32px] py-[55px]">
          {keys.map((data) => <div key={data.title} className="flex flex-col items-center border border-lightestGray pt-[40px] rounded-[16px] shadow-cardShadow">
            <h1 className="text-[20px] font-inter font-semibold text-darkGray">{data.title}</h1>
            <h2 className="text-[16px] font-inter font-noemal text-lightGray">{data.subTitle}</h2>
            <p className="text-[18px] text-center p-[32px] font-inter font-noemal text-lightGray">{data.desc}</p>
          </div>)}
        </div>
        ...
        <div className="grid w-full grid-cols-1 items-center sm:grid-cols-2 gap-8">
          {cardData?.map((data, index) => (
            ...
            >
              ...
              />
              <Link href={data.link} className="flex flex-col w-full absolute p-[2rem] pb-[4rem] sm:p-[3rem] top-[0rem]">
        ...
        <ImageView src={climateEnvironmentCrisis} className="py-[30px]" alt="check" width={1440} height={2709} />
      ...
      <div className="max-w-screen-2xl pt-16 mx-auto px-4 sm:px-[6%]  h-fit flex flex-col gap-12 items-center justify-center w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 mt-8 gap-x-6 px-[112px]">
          {updates.map((card, index) => (
            <div
              className={`flex cursor-pointer items-start ${index === 0 ? "col-span-1 sm:col-span-1 flex-col row-span-1 sm:row-span-2" : "col-span-1 flex-row sm:col-span-1 "}`}
              key={index}
            >
              <ImageView
                src={card.img}
                ...
                width={200}
                height={200}
                className={`${index === 0 ? "w-full h-[13rem] sm:h-full" : "w-full h-40 sm:w-full object-cover"}`}
              />
