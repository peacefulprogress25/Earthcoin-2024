  ...
  const tokenomicsdata = [
    {
      content1: (
        <p className="text-[#475467] text-center sm:text-left font-normal mt-2 lg:mt-8 text-[10px]  lg:text-[14px] font-inter">
          Let&apos;s consider Jimi, who has become an <span className="text-[#EC8000] font-semibold">$EARTH Node</span>.
        </p>
      ),
      content2: (
      ...
      content3: (
        <p className="text-[#475467] text-center sm:text-left font-normal text-[10px] lg:text-[14px] font-inter">1.</p>
      ),
      content4: (
    ...
    },
    {
      ...
      content3: (
        <p className="text-[#475467] text-center sm:text-left font-normal text-[10px] lg:text-[14px] font-inter">2.</p>
      ),
      content4: (
        <p className="text-[#475467] text-center sm:text-left font-normal text-[10px] lg:text-[14px] font-inter">
    ...
    {
      content3: (
        <p className="text-[#475467] text-center sm:text-left font-normal text-[10px] lg:text-[14px]  font-inter">3.</p>
      ),
      content4: (
        <p className="text-[#475467] text-center sm:text-left font-normal text-[10px] lg:text-[14px]  font-inter">
