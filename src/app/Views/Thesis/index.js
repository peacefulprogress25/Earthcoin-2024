  ...
  return (
    <div>
      {!isMobile ? (
        ...
        <>
          <div className="mt-32 px-2 flex flex-col items-center max-w-[480px] mx-auto">
            <div className="flex flex-col items-center w-full gap-2">
              <p className="text-[#EC8000] font-semibold text-center text-[14px] font-inter">
                About
              </p>
            ...
            <div className="sm:px-[8%]  px-4 flex flex-col w-full items-start">
              ...
              <div className="mt-6">
                <p className="text-[#475467] text-center w-full font-normal  text-[15px] max-[480px]:text-[12px] font-inter">
                  ...
                  The world as we know it will have to change completely if we
                  are to address climate change holistically.{" "}
                  <span className="text-[#101828] font-semibold">
                    43 GT of CO2 eqv has to become ZERO in the next 30 years
                  </span>{" "}
                  and the only way that happens is all the infrastructure
              ...
              <div className="lg:w-[60%]">
                ...
                <div className="mt-6">
                  <p className="text-[#475467] text-center sm:text-left font-normal lg:text-[14px] max-[480px]:text-[9px]  text-[16px] font-inter">
                    ...
                    highest yields from land in order to maximize profit. This
                    is highly extractive in nature as it depletes the natural
                    resources required for nutrient rich food and makes no
                    provision to replenish instead pumps more chemicals to
                    compensate.
                    <br />
                    <br />
                    This process also make the land a net carbon emitter where
                    as if the farmer shifts to more regenerative practices which
                    essentially translates to less tilling, more sustainable
                    farming methods to improve top soil health naturally,
                    recycle waste produce as inputs and maintain a robust
                    ecosystem around the farmland. This practice as an added
                    benefit also is capable of absorbing up to 8-9 tones of
                    CO2/acre land annually in its top soil. So not only does it{" "}
                    <span className="text-[#EC8000] font-semibold">
              ...
              <div className="lg:w-[60%]">
                ...
                <div className="mt-6">
                  <p className="text-[#475467] text-center sm:text-left font-normal max-[480px]:text-[9px]  text-[16px] lg:text-[14px] font-inter">
                    ...
                    effect of the over 450 Exa Joules (10^18) produced annually
                    for consumption across sectors, only 8% is from clean
                    sources. This needs to get to over 90% in the next 30 yrs
                    and for that we will need to fund inordinate amounts of
                    wind/solar + battery storage and nuclear power plants.{" "}
                    <span className="text-[#EC8000] font-semibold">
                      That’s over 100 Billion MWh of excess capacity that needs
                      to be installed.
                    </span>{" "}
              ...
              <div className="lg:w-[60%]">
                ...
                <div className="mt-6">
                  <p className="text-[#475467] text-center sm:text-left font-normal max-[480px]:text-[9px]  text-[16px] lg:text-[14px] font-inter">
                    ...
                    football fields of primary forest was being lost every
                    minute. We are literally digging our own graves. These
                    ecosystems are the only thing keeping{" "}
                    <span
                  ...
                  font-semibold"
                    ...
                    on earth habitable as we know it. Providing countless
                    benefits we haven&apos;t even realized.{" "}
                    <span
                      className="text-[#EC8000]
                  font-semibold"
                    >
                      Natural Ecosystems are truly the only scarce resource in
                      this Solar System and it is high time we start valuing
                      them as such.
                    </span>{" "}
                    ...
                    ecosystems and can choose to live harmoniously with them. In
                    a world where between Gold and Bitcoin we have allocated
                    over $8 Trillion in wealth, surely we can find the necessary
                    amount to protect ecosystems which sustain life on earth.
                    Our goal is to ensure that we go from 25% land under
                    conservation currently to 50% total area of Earth under
              ...
              <div className="lg:w-[60%]">
                ...
                <div className="mt-6">
                  <p className="text-[#475467] text-center sm:text-left font-normal  text-[16px] max-[480px]:text-[9px] lg:text-[14px] font-inter">
                    ...
                    become 100% of public transport in the next 30 yrs. We will
                    be funding{" "}
                    <span
                      className="text-[#EC8000]
                  font-semibold"
                    >
                      EV taxis, charging infrastructure, battery manufacturing
                      and its recycling plants, electric buses
                    </span>{" "}
              ...
              <div className="lg:w-[60%]">
                ...
                <div className="mt-8">
                  <p className="text-[#475467] text-center sm:text-left font-normal  text-[16px] max-[480px]:text-[9px] lg:text-[14px] font-inter">
                    ...
                    involves high emissions of C02. Construction activities,
                    including the operation of machinery and transportation of
                    materials, also contribute to greenhouse gas emissions.
                    Buildings consume a substantial amount of energy for
                    heating, cooling, lighting, and other operations. This
                    energy is often sourced from fossil fuels, leading to
                    greenhouse gas emissions. According to the International
                    Energy Agency (IEA), buildings and their construction
                    account for 36% of global energy use and 39% of
                  ...
                  <p className="text-[#475467] text-center sm:text-left font-normal  text-[16px] max-[480px]:text-[9px] font-inter">
                    ...
                    renewable energy, using low carbon materials such as
                    recycled steel or low emission concrete, designed keeping
                    bioregion dynamics in mind, having effective waste
      ...
      <div className="sm:px-[8%] px-4 flex flex-col">
        ...
        {!isMobile ? (
          <div className="relative mt-5">
            <div className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 md:top-1/2 md:left-1/2 lg:top-1/2 lg:left-2/5 xl:top-1/2 xl:left-1/2">
              <p
                className={`mb-3 text-center font-semibold  md:text-[14px] lg:text-[18px] xl:text-[20px] font-syne `}
              >
                They <span className="text-white "> directly address</span> all
        ...
        {!isMobile ? (
          ...
          <>
            <div className="relative mt-5">
              <div className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 md:top-1/2 md:left-1/2 lg:top-1/2 lg:left-2/5 xl:top-1/2 xl:left-1/2">
                <p className=" text-center font-semibold text-[7px] max-[375px]:text-[6px]  font-syne text-nowrap px-6">
                  They cater to humanities{" "}
        ...
        {!isMobile ? (
          ...
          <>
            <div className="relative mt-5">
              <div className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 md:top-1/2 md:left-1/2 lg:top-1/2 lg:left-2/5 xl:top-1/2 xl:left-1/2">
                <p className=" text-center font-semibold text-[7px] max-[375px]:text-[6px] font-syne text-nowrap">
                  All these climate solutions generate tremendous amounts of {" "}
                  <span className="text-white ">
                    {" "}
                    positive <br /> externalities 
        ...
        {!isMobile ? (
          <div className="relative mt-5">
            <div className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 md:top-1/2 md:left-1/2 lg:top-1/2 lg:left-2/5 xl:top-1/2 xl:left-1/2">
              <p className="mb-3 text-center font-semibold  md:text-[14px] lg:text-[18px] xl:text-[20px] font-syne text-nowrap">
                ...
                uncorrelated to crypto sentiment <br /> which ensures strong
                floor value for $Earth.
              </p>
            </div>
            <ImageView
              src={thesisbg4}
          ...
          <>
            <div className="relative mt-5">
              <div className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 md:top-1/2 md:left-1/2 lg:top-1/2 lg:left-2/5 xl:top-1/2 xl:left-1/2">
                <p className=" text-center font-semibold text-[7px] max font-syne text-nowrap">
