      ...
      <div className="sm:px-[15%] px-4 flex flex-col w-full items-start">
        ...
        <div className="mt-6">
          <p className="text-[#475467] text-center sm:text-left font-normal  text-[16px] font-inter">
            ...
            possibilities where we are only <span className="text-[#EC8000] font-semibold">
              limited by our imagination and boundaries of science.
            </span>
          </p>
        </div>
        <div className="mt-12 w-full justify-between flex flex-col lg:flex-row md:flex-col gap-2">
          <div className="lg:w-80 lg:h-64 xl:w-full xl:h-full">
            <ImageView
            src={jungle}
            alt="jungle"
            width={450}
        ...
        <p className="text-[#101828] font-semibold text-left mt-6 text-[20px] sm:text-[28px] mr-10 font-syne">
          The recently experienced exponential advances although are not <span className="text-[#EC8000] font-semibold">decoupled </span>from
        ...
        <div className="mt-6">
          ...
          <p className="text-[#475467] text-center sm:text-left font-normal  text-[16px] font-inter">
            ...
            connectedness of life and that <span className="text-[#000000] font-semibold">
              we are all simply matter processing information differently
            </span> (whether we got the better bargain in this only time can tell).
            ...
            has never been more true. It is essential we understand that <span className="text-[#000000] font-semibold">
              our current superiority is small parts our effort and in large
              parts serendipity.
            </span> <span className="text-[#EC8000] font-semibold">
              Our perpetual superiority will be large parts effort and small
              parts luck.
            </span> Hence tread carefully we must as we are yet to find sign of
      ...
      <div className="sm:px-[15%] px-4 flex flex-col w-full items-start">
        ...
        <div className="my-6">
          <p className="text-[#475467] text-center sm:text-left font-normal  text-[16px] font-inter">
            ...
            that all the while we were <span className="text-black font-semibold">
              focused on aiming for the sky that we were actually digging our
              graves.
            </span> Earth has provided more than our wildest dreams could ask for it
            ...
            SolarpunkDao has conceptualized <span className="text-[#EC8000] font-semibold">$Earth.</span> Recognizing that the problems have come from the separation of
            environment and economy and that for Sapiens to thrive a <span className="text-[#EC8000] font-semibold">
              synergistic relationship between ecology and economy is
              essential. </span> Given the systemic nature of the climate change problem,
        ...
        <div className="mt-12 w-full justify-center flex flex-col lg:justify-center  lg:flex-row md:flex-row lg:gap-25 gap-20">
          <div className="md:w-52 md:h-44 lg:w-72 lg:h-60 ">
            <ImageView
            src={economy}
            alt="jungle"
            width={300}
          ...
          <div className="md:w-60 md:h-48 lg:w-72 lg:h-60  ">
            <ImageView
            src={ecology}
            alt="space"
            width={300}
