    ...
    <>
      ...
      >
        ...
        <Page number="1">
          ...
          <div>
            <p className="text-[#475467] text-left font-normal text-[4.3px] md:text-[8px] lg:text-[10px] xl:text-[15px]  leading-2 xl:leading-7 font-inknutAntiqua mt-4">
      ...
      />
        ...
        <Page number="6">
          <div className="p-3">
            ...
            <div className="xl:h-[430px] mt-2 md:mt-6 h-auto  overflow-hidden">
              <ImageView
                src={tree}
                alt="Tree"
                width={960}
