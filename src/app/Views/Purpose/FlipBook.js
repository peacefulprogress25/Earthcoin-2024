      ...
      {!isMobile ? (
        ...
        >
          ...
          <Page number="1">
            ...
            <div>
              <p className="text-[#475467] text-left font-normal text-[4.3px] sm:text-[15px] leading-2 sm:leading-7 font-inter mt-4">
                ...
                consciousness. From developing language to communicate mythical
                tales of imagined orders now known as culture to establishing
                settled societies because of agriculture, we have propelled
                ourselves to the top of the food chain like a rocket on a
                geological time scale. Our neocortical abilities have enabled us
                to take complex actions in large-scale cooperation frameworks
                (religion, economy, and politics), decode phenomena around us,
                and harness the power of resources due to which we have largely
                bypassed our biological limitations and succeeded in hosting
                over 7 billion of us on Earth. The sapiens design coupled with
                Earth&apos;s resources and its presence in the goldilocks zone
                has created a realm of endless possibilities where we are only{" "}
          ...
          <Page number="3">
            ...
            <div className="pt-2">
              <p className="text-[#475467] text-left font-normal text-[5px] sm:text-[15px] leading-2 sm:leading-7 font-inter">
                ...
                for over a couple million years on this earth. The same earth
                which has had 5 mass extinctions from 450 million yrs back till
                date that has wiped out between 75-90 percent of species every
                time. 4 of those have been climate change induced.
              </p>
            </div>
          </Page>
          ...
          <Page number="4">
            <div className="p-3">
              ...
              <p className="text-[#475467] text-left font-normal sm:text-[15px] text-[4.5px] leading-2 sm:leading-7 font-inter">
                ...
                has meandered its way to the pervasion of neoliberal thought
                that is assumed for &rsquo;reality&rsquo; in today&rsquo;s time.
                The quote that says it is easier to imagine the end of world
                than
              </p>
            </div>
          </Page>
          ...
          <Page number="5">
            <p className="text-[#475467] text-left font-normal sm:text-[15px] text-[5px] leading-2 sm:leading-7 font-inter">
              ...
              parts luck. Hence tread carefully we must as we are yet to find a
              sign of intelligent life absolutely anywhere across the enormously
              chaotic universe we exist in. Even if we do, life as we know it is
              a planetary phenomenon, we will never feel completely at home
          ...
          <Page number="7">
            <p className="text-[#475467] text-left font-normal sm:text-[15px] text-[4.5px] leading-2 sm:leading-7 font-inter">
              ...
              and freshwater depletion. <br /> <br />
              ...
              sustaining life currently and it is nature&rsquo;s way of
              returning the favor we have so dearly bestowed upon it in recent
              times.
              <br /> <br />
          ...
          <Page number="8">
            <p className="text-[#475467] text-left font-normal sm:text-[15px] text-[5px] leading-2 sm:leading-7 font-inter">
              ...
              within our scope of comprehension, unforeseen feedback loops are
              the icing on the proverbial multi-layered climate change cake.
            </p>{" "}
            <br />
            ...
            <p className="text-[#475467] text-left font-normal sm:text-[15px] text-[5px] leading-2 sm:leading-7 font-inter">
              ...
              been unevenly distributed, the perils of climate change too are
              unevenly distributed. It is now a commonly accepted premise that
            </p>{" "}
          </Page>
          ...
          <Page number="9">
            <p className="text-[#475467] text-left font-normal sm:text-[15px] text-[4.5px] leading-2 sm:leading-7 font-inter">
              ...
              problem while the lower rungs of society will be left gasping as
              usual. Un/Fortunately cyclones, fires, viruses, and floods
              ...
              need to address the climate disaster collectively (some more than
              ...
              and becoming a multi-planetary species is truly only possible when
              the environment is conducive towards it. Not when every action
              undertaken to date by 21st-century humans is in direct detriment
          ...
          <Page number="10">
            <p className="text-[#475467] text-left font-normal sm:text-[15px] text-[4.8px] leading-2 sm:leading-7 font-inter">
              ...
              problem from the same level of frequency that created it. Just
              like a web3 world cannot be created with a web2 business model,
              the Solarpunk paradigm cannot be established with the current
        ...
        <>
          ...
          >
            ...
            {/* Page 2 - Image Content */}
            <Page number="2">
              <div className="p-2  sm:mb-6 sm:p-3">
                <div className="sm:h-[230px] sm:mb-4 h-auto mb-2 rounded-lg overflow-hidden">
                  <ImageView
                    src={jungle}
                    alt="Jungle"
            ...
            <Page number="5">
              ...
              <p className="font-semibold sm:text-[28px] text-[6px] leading-2 sm:leading-7 font-syne text-black">
                ...
                come seeking reparations. The Anthropocene era characterized by
                -{/* <br /> */}
                {/* <br /> */}
              </p>
              <p className="sm:text-[15px] text-[5px] leading-2 sm:leading-7">
            ...
            <Page number="7">
              <p className="text-[#475467] text-left font-normal sm:text-[15px] text-[4.5px] leading-2 sm:leading-7 font-inter">
                ...
                the deep systemic fault lines that exist within our ideology of
                sustaining life currently and it is nature&rsquo;s way of
                returning the favor we have so dearly bestowed upon it in recent
                times.
                <br /> <br />
                Climate change is more of an umbrella term to describe the
                various repercussions that a warming earth can have. From raging
                wildfires, rising sea levels, floods and droughts, intensified
                cyclones, widespread hunger, unbearable temperatures to
                unbreathable air. These elements of chaos are fully capable of
                making the COVID pandemic feel like a ripple in a tsunami. Waves
            ...
            <Page number="8">
              ...
              <p className="text-[#475467] text-left font-normal sm:text-[15px] text-[5px] leading-2 sm:leading-7 font-inter">
                ...
                weren&rsquo;t over 7 going to 9 billion humans breathing on this
                planet to face its aftermath in the past. While the fruits of
                development have been unevenly distributed, the perils of
                climate change too are unevenly distributed. It is now a
                commonly accepted premise that
              </p>{" "}
            </Page>
            ...
            <Page number="9">
              <p className="text-[#475467] text-left font-normal sm:text-[15px] text-[4.5px] leading-2 sm:leading-7 font-inter">
                ...
                Since we all (some more than others) have our un/conscious
                contributions towards the creation of this climate disaster, we
                need to address the climate disaster collectively (some more
                than others). Surely in retrospect we don&rsquo;t want to
                ...
                deeper strides in technological innovation, higher standards of
                living, and becoming a multi-planetary species is truly only
                possible when the environment is conducive towards it. Not when
                every action undertaken to date by 21st-century humans is in
                direct detriment of the planet we inhabit.
              </p>
            </Page>
