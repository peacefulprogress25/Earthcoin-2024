  ...
  return (
    <div className="flex w-full items-center  flex-col gap-3">
      <div className="flex gap-1">
        <p
          className={`text-black text-center font-inter text-[16px] font-medium ${
      ...
      <button className="w-[120px] text-white font-inter flex h-10 items-center justify-center rounded-md bg-[#ec8000] p-2 text-[14px]">
        STAKE
      </button>
    </div>
  );
